...
with st.sidebar:
    st.subheader('Persona'); st.write(f"**{p['member']}**"); st.caption(p['snapshot_date']); st.write(p['executive_summary'])
...
st.line_chart(metrics.set_index('date')[['doctor_hours','pt_hours','ruby_hours','performance_hours','nutrition_hours']])